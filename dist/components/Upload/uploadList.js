...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "cs-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "cs-upload-list-item", key: item.uid },
